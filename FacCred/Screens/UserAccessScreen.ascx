<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserAccessScreen.ascx.cs" Inherits="FacCred.Screens.UserAccessScreen" %>
...
<asp:Panel ScrollBars="Vertical" Height="610px" runat="server">
    <div id="rowDiv"  style="width:1000px" >
        <asp:GridView ID="gv_User_Access" runat="server" CssClass="gvdatatable" AutoGenerateColumns="false" 
            OnPreRender="gv_User_Access_PreRender" 
            DataKeyNames="UserID"
            onrowcommand="gv_User_Access_RowCommand"  
            OnSelectedIndexChanging="gv_User_Access_IndexChanging" >
            <Columns>
                <asp:ButtonField  CommandName="gv_User_Access_Select" Text="Select"  ControlStyle-CssClass="globalizedbutton" ControlStyle-Font-Underline="false" ItemStyle-HorizontalAlign="Center"  /> 
