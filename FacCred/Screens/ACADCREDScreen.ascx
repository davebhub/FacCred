<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ACADCREDScreen.ascx.cs" Inherits="FacCred.Screens.ACADCREDScreen" %>
...
<table>
    <tr>
        <td style="color:tomato;width:500px;">
            <common:subheader id="Subheader3" runat="server" text="CREDENTIALS - ACAD-CRED"></common:subheader>
        </td>
        <td>
            <p>
    ...
    <tr>
        <td style="width:250px;">
            <common:subheader id="Subheader2" runat="server" text="All ACAD-CRED Records "></common:subheader>
        </td>
        <td>
