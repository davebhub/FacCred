<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserAccessUpdateScreen.ascx.cs" Inherits="FacCred.Screens.UserAccessUpdateScreen" %>
...
<%--            <tr>
                <td>
                    <common:Subheader ID="SelectInstDivision" runat="server" Text="Institution Division"></common:Subheader> 
                    <asp:DropDownList ID="ddl_InstDivisions" runat="server"  AutoPostBack="false" Width="225px" 
                                       DataTextField="data" DataValueField="value" />
                </td>  
            </tr>
            <tr>
                <td>
                        <common:Subheader ID="SelectDiscipline" runat="server" Text="Select A Discipline to Add"></common:Subheader> 
                        <asp:DropDownList ID="ddl_Disciplines" runat="server"  AutoPostBack="false" Width="225px" 
                            OnLoad="ddl_Disciplines_OnLoad"   
                            OnSelectedIndexChanged="ddl_Disciplines_OnSelectedIndexChanged"  DataTextField="data" DataValueField="value" />
                </td>  
            </tr>--%>
            <tr>
                <td>
                    <common:Subheader ID="SelectSchoolCode" runat="server" Text="School Code (optional)"></common:Subheader> 
            ...
            <td style="width:600px;">  
                ...
                <asp:Panel ScrollBars="Vertical" Height="300px"  runat="server">                  
                    <div class="pSection">
	                    <common:GroupedGrid ID="ggUserAccess" runat="server" DataKeyField="ID" RenderGroupHeaders="True">
		                    <EmptyTableTemplate>
    			                <%= Globalizer.GetGlobalizedString("FACCRED_NO_USER_DIVISION_ACCESS") %>
		                    </EmptyTableTemplate>
		                    <Columns>
<%--                                <asp:TemplateColumn HeaderText="INST_DIV">
				                    <ItemTemplate>
					                    <%# DataBinder.Eval(Container.DataItem, "INST_DIV") %>  
				                    </ItemTemplate>
			                    </asp:TemplateColumn>                            
                                <asp:TemplateColumn HeaderText="Discipline">
				                    <ItemTemplate>
