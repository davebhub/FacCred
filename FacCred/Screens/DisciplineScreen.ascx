<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisciplineScreen.ascx.cs" Inherits="FacCred.Screens.DisciplineScreen" %>
...
<table>
    <tr>
        <td style="color:tomato;width:500px;">
            <common:subheader id="mainTitle" runat="server" text="DISCIPLINE"></common:subheader>
        </td>
        <td>
            <p>
...
<asp:Panel ScrollBars="Vertical" Height="482px" runat="server">
    <div id="rowDiv"  style="width:1000px" >
        <asp:GridView ID="gv_Discipline" runat="server" CssClass="gvdatatable" AutoGenerateColumns="false" 
            OnPreRender="gv_Discipline_PreRender" 
            onrowcommand="gv_Discipline_RowCommand"  
            OnSelectedIndexChanging="gv_Discipline_IndexChanging" >
            <Columns>
                <asp:ButtonField  CommandName="gv_Discipline_Select" Text="Select"  ControlStyle-CssClass="globalizedbutton" ControlStyle-Font-Underline="false" ItemStyle-HorizontalAlign="Center"  />                             
                <asp:BoundField DataField="CATdiv" HeaderText="DIV" />
                <asp:BoundField DataField="CATdivdesc" HeaderText="DIV_DESC" />
                <asp:BoundField DataField="CATinstdiv" HeaderText="INST_DIV" />
                <asp:BoundField DataField="CATinstdivdesc" HeaderText="INST_DIV_DESC" />
                <asp:BoundField DataField="CATschoolcde" HeaderText="SCHOOL_CDE" />  
                <asp:BoundField DataField="CATschoolcdedesc" HeaderText="SCHOOL_CDE_DESC" />                                                        
