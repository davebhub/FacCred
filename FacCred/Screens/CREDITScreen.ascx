<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CREDITScreen.ascx.cs" Inherits="FacCred.Screens.CREDITScreen" %>
...
<table>
    <tr>
        <td style="color:tomato;width:500px;">
            <common:subheader id="Subheader3" runat="server" text="CREDENTIALS - CREDIT"></common:subheader>
        </td>
        <td>
            <p>
...
<asp:Panel ScrollBars="Vertical" Height="482px" runat="server">
    <div id="rowDiv" hidden="hidden" style="width:1050px" >
        <asp:GridView ID="gv_Credit" runat="server" CssClass="gvdatatable" AutoGenerateColumns="true" 
             OnPreRender="gv_Credit_PreRender" 
            onrowcommand="gv_Credit_RowCommand"  
            OnSelectedIndexChanging="gv_Credit_IndexChanging" >
        </asp:GridView>
    </div>
</asp:Panel>
