<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PXCodesScreen.ascx.cs" Inherits="FacCred.Screens.PXCodesScreen" %>
...
<table>
    <tr>
        <td style="color:tomato;width:500px;">
            <common:subheader id="Subheader3" runat="server" text="CREDENTIALS - PX CODES"></common:subheader>
        </td>
        <td>
            <p>
    ...
    <tr>
        <td style="width:250px;">
            <common:subheader id="Subheader2" runat="server" text="All PX Codes"></common:subheader>
        </td>
        <td>
