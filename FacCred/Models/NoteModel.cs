...
{
    public class NoteModel : System.Web.UI.UserControl
    {


        public DataTable getFacultyNotes(string FACidnum, string termcode, string yearcode, string schoolcde, string instdiv)
        {
            ...
            string STMT =
                        @"SELECT NOTE_ID 
                          ...
                          ,UPDATE_BY 
                          ,UPDATE_DATE 
                          ,iif( (expiration_date < getdate() + 60) AND (STATUS = 'A') , 'Y', 'N') as EXPIRES
                      FROM FACCRED_NOTES
                      WHERE
	                    FAC_ID_NUM = @FACidnum 
            ...
            DataColumn dc23 = new DataColumn("EXPIRES");
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        mydr["EXPIRES"] = dr["EXPIRES"].ToString().Trim();
        ...
        public bool updateOneFacultyNote(Guid noteid, string subject, string status, string note, string notetype, string notelevel, DateTime approvaldate, DateTime expirationdate, string updateby, string updatedate)
        {
            string STMT =
                @"UPDATE FACCRED_NOTES 
                    SET  
                        SUBJECT = @subject
                        ,STATUS = @status
                        ,NOTE = @note
            ...
            try
            {
                ...
                DataSet ds = da.execDataSet(STMT,
                    ...
                    new ParamStruct[]
                    {
                        ...
                        new ParamStruct("notetype", notetype, DbType.String, ParameterDirection.Input),
                        new ParamStruct("notelevel", notelevel, DbType.String, ParameterDirection.Input),
                        new ParamStruct("approvaldate", approvaldate, DbType.DateTime, ParameterDirection.Input),
                        new ParamStruct("expirationdate", expirationdate, DbType.DateTime, ParameterDirection.Input),
            ...
            try
            {
                ...
                DataSet ds = da.execDataSet(STMT,
                    ...
                    new ParamStruct[]
                    {
                        ...
                        new ParamStruct("facidnum", facidnum, DbType.String, ParameterDirection.Input),
                        new ParamStruct("smappid", smappid, DbType.String, ParameterDirection.Input),
                        new ParamStruct("crscde", crscde, DbType.String, ParameterDirection.Input),
                        new ParamStruct("crstitle", crstitle, DbType.String, ParameterDirection.Input),
                        new ParamStruct("divcde", divcde, DbType.String, ParameterDirection.Input),
                        new ParamStruct("institdivcde", institdivcde, DbType.String, ParameterDirection.Input),
                        new ParamStruct("schoolcde", schoolcde, DbType.String, ParameterDirection.Input),
                        new ParamStruct("yearcode", yearcode, DbType.String, ParameterDirection.Input),
                        new ParamStruct("termcode", termcode, DbType.String, ParameterDirection.Input),
                        new ParamStruct("subject", subject, DbType.String, ParameterDirection.Input),
                        ...
                        new ParamStruct("approvaldate", approvaldate, DbType.DateTime, ParameterDirection.Input),
                        new ParamStruct("expirationdate", expirationdate, DbType.DateTime, ParameterDirection.Input),
                        new ParamStruct("createdby", createdby, DbType.String, ParameterDirection.Input),
                        new ParamStruct("createdate", createdate, DbType.DateTime, ParameterDirection.Input),
                        new ParamStruct("updateby", updateby, DbType.String, ParameterDirection.Input),
                        new ParamStruct("updatedate", updatedate, DbType.String, ParameterDirection.Input)
                    });
        ...
        public bool moveNoteToArchive(Guid noteid)
        {
            ...
            string STMT =
            @"INSERT INTO FACCRED_NOTES_ARCHIVE(
                        NOTE_ID
                       ,FAC_APPID
                       ,FAC_ID_NUM
                       ,SM_APPID
